...
BinaryDecoder.prototype = {
    ...
    readLong: function () {
        ...
        while ((b & 0x80) != 0) {
            ...
            n = n.or(new Int64(b & 0x7F).shiftLeft(shift));
            shift += 7
        }
        ...
        n = n.shiftRight(1);
        if (sign == 1) {
            n = n.xor(L_0xFFFF).or(L_0x80);
        }
        return parseInt(n.toSignedDecimalString());
    },
...
var L_0x7f = new Int64(0x7F);
var L_0x80 = new Int64(0x80);
var NL_0X7f = new Int64(-1,-128);
var L_0xFFFE = new Int64(0xFFFFFFFF, 0xFFFFFFFE);
var L_0xFFFF = new Int64(-1, -1);
var L_SIGN = new Int64(0x80000000,0)
var L_0xFF = new Int64(0xFF);
var L_0x0 = new Int64(0)
...
BinaryEncoder.prototype = {
    ...
    writeLong: function(value) {
        ...
        var signbit = L_0xFFFE;
        if (n.and(L_SIGN).compare(L_0x0) == 0) {
            signbit = L_0x0;
        }

        n = (n.shiftLeft(1)).xor((n.shiftRight(63).or(signbit)));
        if (n.and(NL_0X7f).compare(L_0x0) != 0) {
            wb(n.or(L_0x80).and(L_0xFF).low32());
            n = n.shiftRight(7);
            var numShifts = 0;
            while (n.compare(L_0x7f)==1 && numShifts < 8) {
                wb(n.or(L_0x80).and(L_0xFF).low32());
                n = n.shiftRight(7);
                numShifts++;
            }
        }
        wb(n.and(L_0xFF).low32());
    },
